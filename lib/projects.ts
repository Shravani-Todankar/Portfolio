...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    mockup: "/projects/finvvritti/mockup.png",
    mockupRatio: 16 / 9,
    tagline:
    ...
    approach:
      "I focused on building a structured and user-friendly experience with clean layouts and readable content flow. The design implementation prioritized clarity, spacing, and responsiveness to make information easier to consume. I optimized page structures, navigation behavior, and frontend styling to maintain consistency throughout the site while ensuring the platform remained lightweight, scalable, and easy for ongoing content management.",
    features: [
      "Responsive multi-device layout",
    ...
    whyBuilt: [
      "To create a trustworthy digital presence for the brand",
      "To simplify access to financial service information",
      "To ensure smooth usability across devices",
      "To support scalable and manageable content updates",
    ],
    impact: [
      "Improved clarity of service presentation",
      "Created a smoother browsing experience for visitors",
      "Delivered a professional and consistent visual identity",
      "Made content easier to maintain and update",
      "Established a stable and responsive live website",
    ],
    gallery: [],
  },
  {
    ...
    features: [
      ...
      "Custom Webflow animations and transitions",
      "Fully responsive page layouts",
      "Media-rich visual presentation",
      "Structured content flow across sections",
      "Smooth navigation interactions",
      "Consistent modern UI styling",
      "Optimised performance for animated sections",
    ],
    stack: {
      platform: ["Webflow"],
      frontend: ["HTML", "CSS", "JavaScript", "Webflow Interactions"],
      infrastructure: ["Webflow Hosting", "SSL"],
    },
    whyBuilt: [
      "Create a visually immersive digital experience",
      "Translate complex design concepts into a functional website",
      "Ensure animations remained smooth across devices",
      "Maintain consistency between interaction and usability",
    ],
    impact: [
      "Delivered a stronger visual identity for the brand",
      "Improved engagement through interactive browsing",
      "Smoother responsive experience across screen sizes",
      "Maintained performance despite animation-heavy sections",
      "Provided a polished and modern live website experience",
    ],
    gallery: [],
  },
];
